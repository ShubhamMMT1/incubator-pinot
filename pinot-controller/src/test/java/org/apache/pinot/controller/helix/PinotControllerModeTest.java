...
public class PinotControllerModeTest extends ControllerTest {
  ...
  public void testDualModeController() {
    ...
    PinotHelixResourceManager pinotHelixResourceManager = firstDualModeController.getHelixResourceManager();

    // Disable delay rebalance feature
    IdealState idealState = pinotHelixResourceManager.getTableIdealState(LEAD_CONTROLLER_RESOURCE_NAME);
    idealState.setDelayRebalanceEnabled(false);
    idealState.setMinActiveReplicas(1);
    helixAdmin.updateIdealState(getHelixClusterName(), LEAD_CONTROLLER_RESOURCE_NAME, idealState);
    ...
    final LeadControllerManager firstLeadControllerManager =
        firstDualModeController.getHelixResourceManager().getLeadControllerManager();
    ...
    firstDualModeController.getHelixResourceManager().enableLeadControllerResource(true);
    ...
    pinotHelixResourceManager = thirdDualModeController.getHelixResourceManager();
    helixAdmin = thirdDualModeController.getHelixControllerManager().getClusterManagmentTool();
    TestUtils
